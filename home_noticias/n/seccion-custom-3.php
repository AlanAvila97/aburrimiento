                        ...
                        <div class="flex-column-reverse flex-lg-row row w-100 mx-0">
                            ...
                            <div class="container-conflicts">
                                <div class="w-50">
                                    ...
                                    <?php 
                        $image = $imagen1_tag1; 
                        $principalContent = $titulo1_tag1;
                        $subtitle1 = $titulo2_tag1;
                        $summary1 = $extracto2_tag1;
                        $subtitle2 = $titulo3_tag1;
                        $summary2 = $extracto3_tag1;
                        $link1 = $link1_tag1;
                        $link2 = $link2_tag1;
                        $link3 = $link3_tag1;
                        include get_template_directory() . '/templates/partials/partials/components/grid-notas-horizontal.php';?>
                                </div>
                                <!-- Memoria e Identidad -->
                                <div class="container-migrations">
                                    ...
                                    <?php 
                        $image = $imagen1_tag2; 
                        $principalContent = $titulo1_tag2;
                        $subtitle1 = $titulo2_tag2;
                        $summary1 = $extracto2_tag2;
                        $subtitle2 = $titulo3_tag2;
                        $summary2 = $extracto3_tag2;
                        $link1 = $link1_tag2;
                        $link2 = $link2_tag2;
                        $link3 = $link3_tag2;
                       include get_template_directory() . '/templates/partials/partials/components/grid-notas-horizontal.php';?>
