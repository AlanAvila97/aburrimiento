...
elseif( is_category() ){
	...
	switch ($category_id) {
		case 34:
			...
			$tag_1 = 52896;
			$tag_2 = 27525;
			$name_tag_class = 'h4 border-after-end';
			$name_notas_relacionadas_class = 'h4 border-after-end';
			$name_notas_relacionadas = 'Notas Relacionadas';
			wp_enqueue_style(
				'categoria-cultura',
				get_template_directory_uri() . '/templates/partials/assets/css/culture.css'
			);
			break;
		case 37:
			//Economia
			...
			wp_enqueue_style(
				'categoria-economia',
				get_template_directory_uri() . '/templates/partials/assets/css/economia.css'
			);
			break;
		case 23:
			//Internacional
			...
			wp_enqueue_style(
				...
				get_template_directory_uri() . '/templates/partials/assets/css/internacional.css'
			);
			break;
		case 62026:
			//Entretenimiento
			...
			wp_enqueue_style(
				...
				get_template_directory_uri() . '/templates/partials/assets/css/entretenimiento.css'
			);
			break;
		case 29:
			//Salud
			...
			wp_enqueue_style(
				'categoria-salud',
				get_template_directory_uri() . '/templates/partials/assets/css/salud.css'
			);
			break;
		/*case 34:
	...
	$ids_excluir = wp_list_pluck($cat_posts1, 'ID');
	$imagen1 = isset($cat_posts1[0]) ? wp_get_attachment_image_src(get_post_thumbnail_id($cat_posts1[0]->ID), 'minis')[0] : '';
	$imagen2 = isset($cat_posts1[1]) ? wp_get_attachment_image_src(get_post_thumbnail_id($cat_posts1[1]->ID), 'minis')[0] : '';
	$imagen3 = isset($cat_posts1[2]) ? wp_get_attachment_image_src(get_post_thumbnail_id($cat_posts1[2]->ID), 'minis')[0] : '';
	$link1 = isset($cat_posts1[0]) ? get_permalink($cat_posts1[0]->ID) : '#';
	$link2 = isset($cat_posts1[1]) ? get_permalink($cat_posts1[1]->ID) : '#';
	$link3 = isset($cat_posts1[2]) ? get_permalink($cat_posts1[2]->ID) : '#';
	//Seccion 1
	switch ($seccion_1) {
		case 1:
			include_once get_template_directory() . '/templates/partials/partials/components/grid-notas-collage-hotizontal.php';
			break;
		case 2:
			$hrfs = [$link1,$link2,$link3];
            $images = [
                $imagen1,$imagen2,$imagen3
            ];
			include_once get_template_directory() . '/templates/partials/partials/components/grid-notas-collage-vertical-estructura.php';
			break;
		case 3:
			$arg_en_corto = array( 
				'category__in' => 65546,
				...
				'order' => 'DESC',
				'posts_per_page' => 5,
				'post__not_in' => $ids_excluir,
			); 
			$cat_posts_en_corto = get_posts($arg_en_corto);
			$linkcorto1 = isset($cat_posts_en_corto[0]) ? get_permalink($cat_posts_en_corto[0]->ID) : '#';
			$linkcorto2 = isset($cat_posts_en_corto[1]) ? get_permalink($cat_posts_en_corto[1]->ID) : '#';
			$linkcorto3 = isset($cat_posts_en_corto[2]) ? get_permalink($cat_posts_en_corto[2]->ID) : '#';
			$linkcorto4 = isset($cat_posts_en_corto[3]) ? get_permalink($cat_posts_en_corto[3]->ID) : '#';
			$linkcorto5 = isset($cat_posts_en_corto[4]) ? get_permalink($cat_posts_en_corto[4]->ID) : '#';
			$titulocorto1 = isset($cat_posts_en_corto[0]) ? get_the_title($cat_posts_en_corto[0]->ID) : '';
			$titulocorto2 = isset($cat_posts_en_corto[1]) ? get_the_title($cat_posts_en_corto[1]->ID) : '';
			$titulocorto3 = isset($cat_posts_en_corto[2]) ? get_the_title($cat_posts_en_corto[2]->ID) : '';
			$titulocorto4 = isset($cat_posts_en_corto[3]) ? get_the_title($cat_posts_en_corto[3]->ID) : '';
			$titulocorto5 = isset($cat_posts_en_corto[4]) ? get_the_title($cat_posts_en_corto[4]->ID) : '';
			$imagen1_corto = isset($cat_posts_en_corto[0]) ? wp_get_attachment_image_src(get_post_thumbnail_id($cat_posts_en_corto[0]->ID), 'minis')[0] : '';
			$imagen2_corto = isset($cat_posts_en_corto[1]) ? wp_get_attachment_image_src(get_post_thumbnail_id($cat_posts_en_corto[1]->ID), 'minis')[0] : '';
			$imagen3_corto = isset($cat_posts_en_corto[2]) ? wp_get_attachment_image_src(get_post_thumbnail_id($cat_posts_en_corto[2]->ID), 'minis')[0] : '';
			$imagen4_corto = isset($cat_posts_en_corto[3]) ? wp_get_attachment_image_src(get_post_thumbnail_id($cat_posts_en_corto[3]->ID), 'minis')[0] : '';
			$imagen5_corto = isset($cat_posts_en_corto[4]) ? wp_get_attachment_image_src(get_post_thumbnail_id($cat_posts_en_corto[4]->ID), 'minis')[0] : '';
			include_once get_template_directory() . '/templates/partials/partials/components/grid-notas-collage-entretenimiento.php';
			break;
	}
	//Seccion 2
	switch ($seccion_2) {
		case 1:
			...
			$tag_posts1 = get_posts($tag1);
			$imagen1_tag1 = isset($tag_posts1[0]) ? wp_get_attachment_image_src(get_post_thumbnail_id($tag_posts1[0]->ID), 'minis')[0] : '';
			$imagen2_tag1 = isset($tag_posts1[1]) ? wp_get_attachment_image_src(get_post_thumbnail_id($tag_posts1[1]->ID), 'minis')[0] : '';
			$imagen3_tag1 = isset($tag_posts1[2]) ? wp_get_attachment_image_src(get_post_thumbnail_id($tag_posts1[2]->ID), 'minis')[0] : '';
			$titulo1_tag1 = isset($tag_posts1[0]) ? get_the_title($tag_posts1[0]->ID) : '';
			$titulo2_tag1 = isset($tag_posts1[1]) ? get_the_title($tag_posts1[1]->ID) : '';
			$titulo3_tag1 = isset($tag_posts1[2]) ? get_the_title($tag_posts1[2]->ID) : '';
			$link1_tag1 = isset($tag_posts1[0]) ? get_permalink($tag_posts1[0]->ID) : '';
			$link2_tag1 = isset($tag_posts1[1]) ? get_permalink($tag_posts1[1]->ID) : '';
			$link3_tag1 = isset($tag_posts1[2]) ? get_permalink($tag_posts1[2]->ID) : '';
			$extracto1_tag1 = isset($tag_posts1[0]) ? get_the_excerpt($tag_posts1[0]->ID) : '';
			$extracto2_tag1 = isset($tag_posts1[1]) ? get_the_excerpt($tag_posts1[1]->ID) : '';
			$extracto3_tag1 = isset($tag_posts1[2]) ? get_the_excerpt($tag_posts1[2]->ID) : '';
			$tag_1_content = get_tag($tag_1);
			$name_tag_1 = $tag_1_content->name;
			$tag2 = array( 
				'post_type' => 'post',
				'posts_per_page' => 2,
				'order' => 'DESC',
			...
			$tag_posts2 = get_posts($tag2);
			$imagen1_tag2 = isset($tag_posts2[0]) ? wp_get_attachment_image_src(get_post_thumbnail_id($tag_posts2[0]->ID), 'minis')[0] : '';
			$imagen2_tag2 = isset($tag_posts2[1]) ? wp_get_attachment_image_src(get_post_thumbnail_id($tag_posts2[1]->ID), 'minis')[0] : '';
			$imagen3_tag2 = isset($tag_posts2[2]) ? wp_get_attachment_image_src(get_post_thumbnail_id($tag_posts2[2]->ID), 'minis')[0] : '';
			$titulo1_tag2 = isset($tag_posts2[0]) ? get_the_title($tag_posts2[0]->ID) : '';
			$titulo2_tag2 = isset($tag_posts2[1]) ? get_the_title($tag_posts2[1]->ID) : '';
			$titulo3_tag2 = isset($tag_posts2[2]) ? get_the_title($tag_posts2[2]->ID) : '';
			$link1_tag2 = isset($tag_posts2[0]) ? get_permalink($tag_posts2[0]->ID) : '';
			$link2_tag2 = isset($tag_posts2[1]) ? get_permalink($tag_posts2[1]->ID) : '';
			$link3_tag2 = isset($tag_posts2[2]) ? get_permalink($tag_posts2[2]->ID) : '';
			$extracto1_tag2 = isset($tag_posts2[0]) ? get_the_excerpt($tag_posts2[0]->ID) : '';
			$extracto2_tag2 = isset($tag_posts2[1]) ? get_the_excerpt($tag_posts2[1]->ID) : '';
			$extracto3_tag2 = isset($tag_posts2[2]) ? get_the_excerpt($tag_posts2[2]->ID) : '';
			$tag_2_content = get_tag($tag_2);
			$name_tag_2 = $tag_2_content->name;
			$args5 = array( 
				'post_type' => 'post',
				'posts_per_page' => 10,
				'order' => 'DESC',
			...
			$cat_posts5 = get_posts($args5);
			$ids_excluir  = array_merge($ids_excluir, wp_list_pluck($cat_posts5, 'ID'));
			$argsRecientes = array( 
				'post_type' => 'post',
				'posts_per_page' => 5,
				'order' => 'DESC',
			...
			$cat_posts_recientes = get_posts($argsRecientes);
			$linkrecientes1 = isset($cat_posts_recientes[0]) ? get_permalink($cat_posts_recientes[0]->ID) : '#';
			$linkrecientes2 = isset($cat_posts_recientes[1]) ? get_permalink($cat_posts_recientes[1]->ID) : '#';
			$linkrecientes3 = isset($cat_posts_recientes[2]) ? get_permalink($cat_posts_recientes[2]->ID) : '#';
			$linkrecientes4 = isset($cat_posts_recientes[3]) ? get_permalink($cat_posts_recientes[3]->ID) : '#';
			$linkrecientes5 = isset($cat_posts_recientes[4]) ? get_permalink($cat_posts_recientes[4]->ID) : '#';
			$titulorecientes1 = isset($cat_posts_recientes[0]) ? get_the_title($cat_posts_recientes[0]->ID) : '';
			$titulorecientes2 = isset($cat_posts_recientes[1]) ? get_the_title($cat_posts_recientes[1]->ID) : '';
			$titulorecientes3 = isset($cat_posts_recientes[2]) ? get_the_title($cat_posts_recientes[2]->ID) : '';
			$titulorecientes4 = isset($cat_posts_recientes[3]) ? get_the_title($cat_posts_recientes[3]->ID) : '';
			$titulorecientes5 = isset($cat_posts_recientes[4]) ? get_the_title($cat_posts_recientes[4]->ID) : '';
			$argsfinal = array( 
				'post_type' => 'post',
				'posts_per_page' => 3,
				'order' => 'DESC',
			...
			$cat_posts_final = get_posts($argsfinal);
			$imagenfinal1 = isset($cat_posts_final[0]) ? wp_get_attachment_image_src(get_post_thumbnail_id($cat_posts_final[0]->ID), 'minis')[0] : '';
			$imagenfinal2 = isset($cat_posts_final[1]) ? wp_get_attachment_image_src(get_post_thumbnail_id($cat_posts_final[1]->ID), 'minis')[0] : '';
			$imagenfinal3 = isset($cat_posts_final[2]) ? wp_get_attachment_image_src(get_post_thumbnail_id($cat_posts_final[2]->ID), 'minis')[0] : '';
			$linkfinal1 = isset($cat_posts_final[0]) ? get_permalink($cat_posts_final[0]->ID) : '#';
			$linkfinal2 = isset($cat_posts_final[1]) ? get_permalink($cat_posts_final[1]->ID) : '#';
			$linkfinal3 = isset($cat_posts_final[2]) ? get_permalink($cat_posts_final[2]->ID) : '#';
			$titulofinal1 = isset($cat_posts_final[0]) ? get_the_title($cat_posts_final[0]->ID) : '';
			$titulofinal2 = isset($cat_posts_final[1]) ? get_the_title($cat_posts_final[1]->ID) : '';
			$titulofinal3 = isset($cat_posts_final[2]) ? get_the_title($cat_posts_final[2]->ID) : '';
			include_once get_template_directory() . '/templates/partials/partials/components/seccion-custom-1.php';
			break;
		case 2:
			$tag1 = array( 
				'post_type' => 'post',
			...
			$titulofinal2 = isset($cat_posts_final[1]) ? get_the_title($cat_posts_final[1]->ID) : '';
			$titulofinal3 = isset($cat_posts_final[2]) ? get_the_title($cat_posts_final[2]->ID) : '';
			include_once get_template_directory() . '/templates/partials/partials/components/seccion-custom-2.php';
			break;
		case 3:
			$tag1 = array( 
				'post_type' => 'post',
			...
			$titulofinal2 = isset($cat_posts_final[1]) ? get_the_title($cat_posts_final[1]->ID) : '';
			$titulofinal3 = isset($cat_posts_final[2]) ? get_the_title($cat_posts_final[2]->ID) : '';
			include_once get_template_directory() . '/templates/partials/partials/components/seccion-custom-3.php';
			break;
		default:
			break;
	}
	...
	$titulofinal2 = isset($cat_posts_final[1]) ? get_the_title($cat_posts_final[1]->ID) : '';
	$titulofinal3 = isset($cat_posts_final[2]) ? get_the_title($cat_posts_final[2]->ID) : '';
	include_once get_template_directory() . '/templates/partials/partials/components/grid-notas-columnas.php';
	*/
	...
	// Cache field key
	$cache_key = tie_get_cache_key( 'slider-cat-'.$category_id );
	/*
	$slider_settings = array(
		...
		'limit_published_days' => tie_get_category_option( 'featured_limit_published_days' ),
...
if( ! empty( $slider_settings ) ){
	...
	elseif( $featured_posts ){
		...
		if( tie_get_option( 'jso_cache' ) && ! empty( $cache_key ) && false !== get_transient( $cache_key ) /*&& ! ( defined( 'WP_CACHE' ) && WP_CACHE )*/ ){
			...
			if( $slider != 'videos-list' && $slider != 'videos_list' ){
				...
				if( ! empty( $query_type ) && $query_type == 'custom' ){
					...
					$args['trending_posts'] = $trending_posts;
					$args['limit_published_days'] = $limit_published_days;
      ...
      $before_slider = $lazy_or_no_content . '
			...
			// Before Slider Action
			do_action( 'TieLabs/Builder/before_slider', $slider );
