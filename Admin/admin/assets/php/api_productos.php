...
$query1 = "SELECT * FROM galeria where id=2";
$result1 = $conexion->query($query1);

$query2 = "SELECT * FROM galeria where id=3";
$result2 = $conexion->query($query2);

// Realizar la segunda consulta
$query3 = "SELECT * from titulos where id=14";
$result3 = $conexion->query($query3);

$query4 = "SELECT * from titulos where id=15";
$result4 = $conexion->query($query4);

$query5 = "SELECT * from titulos where id=16";
$result5 = $conexion->query($query5);

$query6 = "SELECT * FROM valores order by id asc";
$result6 = $conexion->query($query6);

$query7 = "SELECT * from productos where tipo='Producto'";
...
if ($result1 && $result2) {
    ...
    $data['productos'] = $result7->fetch_all(MYSQLI_ASSOC);
...
if (file_put_contents("json/api_productos.json", $jsonData)) {
