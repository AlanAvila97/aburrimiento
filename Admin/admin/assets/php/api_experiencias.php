...
$query1 = "SELECT * FROM galeria where id=6";
$result1 = $conexion->query($query1);

$query2 = "SELECT * FROM galeria where id=7";
$result2 = $conexion->query($query2);

// Realizar la segunda consulta
$query3 = "SELECT * from titulos where id=20";
$result3 = $conexion->query($query3);

$query4 = "SELECT * from titulos where id=21";
$result4 = $conexion->query($query4);

$query5 = "SELECT * from titulos where id=22";
$result5 = $conexion->query($query5);

$query7 = "SELECT * from experiencias";
$result7 = $conexion->query($query7);

$query8 = "SELECT * from titulos where id=8";
...
if ($result1 && $result2) {
    ...
    $data['titulo_experiencias'] = $result8->fetch_all(MYSQLI_ASSOC);
    ...
    $data['experiencias'] = $result7->fetch_all(MYSQLI_ASSOC);
...
if (file_put_contents("json/api_experiencias.json", $jsonData)) {
